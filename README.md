...
-Assigned IP addresses to hosts, routers, and switches
...
-Configured DHCP servers to dynamically assign IP addresses to hosts

-Set up DHCP pools per VLAN with default gateways 
...
-Configured user authentication and privilege levels
...
-Implemented floating static routes as backup paths with higher administrative distance
